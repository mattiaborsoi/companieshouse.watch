...
export function formatFilingDescription(type: string, description: string | null | undefined): string {
  ...
  const known: Record<string, string> = {
    ...
    "dissolution-application-strike-off-company":  "Dissolution application (strike off)",
    "accounts-with-accounts-type-micro-entity":    "Micro-entity accounts",
    "accounts-with-accounts-type-total-exemption-full": "Total exemption full accounts",
    "accounts-with-accounts-type-total-exemption-small": "Total exemption small accounts",
    ...
    "confirmation-statement-with-no-updates":      "Confirmation statement (no updates)",
    "confirmation-statement-with-updates":         "Confirmation statement (with updates)",
    "change-to-a-person-with-significant-control": "PSC details changed",
    "mortgage-create-with-deed-with-charge-number-charge-creation-date": "Charge created",
    "officer-appointed":                           "Officer appointed",
    "officer-resigned":                            "Officer resigned",
    "registered-office-changed":                   "Registered office changed",
    "incorporation-with-all-name-exemptions":      "Company incorporated",
    "change-of-name-certificate":                  "Name changed",
