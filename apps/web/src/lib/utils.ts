...
// UK SIC 2007 code descriptions
const SIC_CODES: Record<string, string> = {
  "01110": "Growing of cereals (excl. rice), leguminous crops and oil seeds",
  ...
  "10822": "Manufacture of other sugar confectionery",
  ...
  "18129": "Printing (other than printing of newspapers and printing on labels)",
  ...
  "26511": "Manufacture of electronic instruments and apparatus for measuring",
  "26512": "Manufacture of electronic industrial process control equipment",
  "26513": "Manufacture of non-electronic instruments and apparatus for measuring",
  ...
  "47599": "Retail sale of furniture, lighting equipment and other household articles",
  "47610": "Retail sale of books",
  "47621": "Retail sale of newspapers",
  "47622": "Retail sale of stationery",
  ...
  "65201": "Lloyd's syndicates",
  "65202": "Other reinsurance",
  ...
  "84120": "Regulation of the activities of providing health care, education, cultural services and other social services",
  ...
  "86101": "Hospital activities with inpatient care",
...
const SIC_DIVISION: Record<string, string> = {
  ...
  "47": "Retail trade (excl. motor vehicles)",
...
export function sicDescription(code: string): string {
  const exact = SIC_CODES[code];
  if (exact) return exact;
  const div = code.slice(0, 2);
  return SIC_DIVISION[div] ?? "";
}
...
export function formatFilingDescription(type: string, description: string | null | undefined): string {
  ...
  const known: Record<string, string> = {
    ...
    "AD02": "Registered office changed",
    "AD03": "Registered office changed",
    "AD04": "Registers moved to SAIL address",
    "AD05": "SAIL address changed",
    "TM02": "Secretary terminated",
    "AP02": "Secretary appointed",
    "AP03": "Secretary appointed (corporate)",
    "CH02": "Secretary details changed",
    "CH03": "Secretary details changed (corporate)",
    "AR01": "Annual return",
    "SH01": "Return of allotment of shares",
    "SH02": "Notice of consolidation, sub-division, redemption of shares",
    "SH03": "Return of purchase of own shares",
    "SH06": "Cancellation of shares",
    "NEWINC": "Company incorporated",
    "DISS16a": "Voluntary strike-off discontinued",
    "GAZ1": "First gazette notice",
    "GAZ2": "Final gazette notice",
    "PSC01": "PSC notification",
    "PSC02": "PSC notification (corporate entity)",
    "PSC03": "PSC notification (legal person)",
    "PSC07": "PSC ceased",
    "PSC08": "PSC ceased (corporate entity)",
    "PSC09": "PSC ceased (legal person)",
    // Description slugs not covered by type codes above
    "annual-return-company-with-made-up-date-full-list-shareholders": "Annual return",
    "annual-return-company-with-made-up-date-no-member-list": "Annual return",
    "capital-allotment-shares": "Shares allotted",
    "incorporation-company": "Company incorporated",
    "move-registers-to-sail-company-with-new-address": "Registers moved to SAIL address",
    "change-sail-address-company-with-new-address": "SAIL address changed",
    "change-account-reference-date-company-previous-shortened": "Accounting reference date changed",
    "change-account-reference-date-company-current-extended": "Accounting reference date extended",
    "termination-secretary-company-with-name-termination-date": "Secretary terminated",
    "termination-director-company-with-name-termination-date": "Director terminated",
    "change-person-director-company-with-change-date": "Director details changed",
    "change-person-secretary-company-with-change-date": "Secretary details changed",
  };
